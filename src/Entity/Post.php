...
namespace App\Entity;
    ...
    class Post
    {
         ...
         */
        public function __construct(int $id_post, int $id_usuario, int $id_comentario, int $id_seccion, int $id_votes, string $title, string $description, string $publication_date, string $modification_date)
        {
